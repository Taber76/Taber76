...
# 💻 Tech Stack:
[![My Skills](https://skillicons.dev/icons?i=js,nodejs,ts,py,nextjs,postgres,mongodb,mysql,prisma,aws,gcp,docker,vercel,sequelize,firebase,sqlite,nestjs,express,graphql,electron,flask,raspberrypi,html,css,bootstrap,react,redux,vite,git,github,postman,vscode&perline=8)](https://skillicons.dev)
# 📊 GitHub Stats:
