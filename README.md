...
# 💻 Tech Stack:
[![My Skills](https://skillicons.dev/icons?i=js,nodejs,ts,nestjs,express,graphql,electron,postgres,mongodb,mysql,firebase,sqlite,prisma,sequelize,py,flask,raspberrypi,aws,vercel,gcp,html,css,bootstrap,react,redux,vite,git,github,postman,vscode&perline=4)](https://skillicons.dev)
# 📊 GitHub Stats:
